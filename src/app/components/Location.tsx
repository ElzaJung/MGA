          ...
          <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8 max-w-4xl mx-auto border border-[#FFCB2F]/20">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                <div className="bg-[#FFCB2F] rounded-full w-10 h-10 md:w-16 md:h-16 flex items-center justify-center flex-shrink-0">
                  <svg className="w-5 h-5 md:w-8 md:h-8 text-white" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div>
                  <h3 className="hidden md:block font-display text-xl md:text-2xl font-bold text-[#1A1A1A]">MyungGa Korean Restaurant</h3>
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="hidden md:block font-body text-sm text-[#1A1A1A]/60">
                      Google Reviews
                    </span>
                  </div>
                </div>
